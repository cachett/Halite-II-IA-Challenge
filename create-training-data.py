...
ship_requirement_min = 2
ship_requirement_max = 300
damage_requirement = 750
...
for num in range(2000):
    try:
        ...
        os.system('halite.exe -d "360 240" -r -t "python MyBot-ML-v3.1.py" "python MyBot-ML-v3.2.py" >> data.gameout')
        ...
        if CharlesBot1_rank == 1:
            print("c3.1 won")
            player_1_wins += 1
            if CharlesBot1_ships >= ship_requirement_min and  CharlesBot1_ships <= ship_requirement_max and CharlesBot1_dmg >= damage_requirement:
                with open("c3.1_input.vec","r") as f:
                    input_lines = f.readlines()
                with open("c3.1_out.vec","r") as f:
            ...
            print("c3.2 won")
            player_2_wins += 1
            if CharlesBot2_ships >= ship_requirement_min and  CharlesBot2_ships <= ship_requirement_max and CharlesBot2_dmg >= damage_requirement:
                with open("c3.2_input.vec","r") as f:
                    input_lines = f.readlines()
                with open("c3.2_out.vec","r") as f:
                    output_lines = f.readlines()
